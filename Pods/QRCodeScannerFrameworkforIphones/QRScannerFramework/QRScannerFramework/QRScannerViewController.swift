...
class QRViewfinderOverlayView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        NSLayoutConstraint.activate([
            ...
            imageView.widthAnchor.constraint(equalTo: widthAnchor, multiplier: 6.0), // Adjust the multiplier to control the size
            imageView.heightAnchor.constraint(equalTo: heightAnchor, multiplier: 0.5) // Adjust the multiplier to control the size
        ])
...
class BarCodeViewfinderOverlayView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        NSLayoutConstraint.activate([
            imageView.centerXAnchor.constraint(equalTo: centerXAnchor),
            imageView.centerYAnchor.constraint(equalTo: centerYAnchor),
            imageView.widthAnchor.constraint(equalToConstant: 200), // Adjust the multiplier to control the width
               imageView.heightAnchor.constraint(equalToConstant: 150) // Adjust the multiplier to control the height
        ])
