...
class ViewController: UIViewController, QRScannerDelegate {
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            barcodeImageView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 100),
            ...
            qrCodeImageView.topAnchor.constraint(equalTo: scanBarcodeButton.bottomAnchor, constant: 100),
